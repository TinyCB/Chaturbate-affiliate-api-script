...
- **memory_limit:** Set this to at least `256M` or `512M` in `php.ini`, as `model_profiles.json` may quickly reach 50MB+ and require additional memory for reliable operation.
